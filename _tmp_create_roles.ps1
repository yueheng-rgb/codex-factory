$dir = "C:\Codex_App_Factory\factory-agent-company-protocol-pack\roles"

# File 1: main-agent-orchestrator.md
@"
...
| Rule | Detection |
|------|-----------|
| Undeclared fallback detection | Agent silently falls back to simpler implementation → violation |
...
"@ | Out-File -FilePath "$dir\main-agent-orchestrator.md" -Encoding utf8

Write-Host "Created: main-agent-orchestrator.md"
