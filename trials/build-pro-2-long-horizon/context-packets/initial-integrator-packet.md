# Context Packet: CP-1046-20260627154008

- **Target Phase**: FACTORY-BUILD-PRO-2
- **Target Role**: integrator
- **Packet Type**: PHASE_START_PACKET
- **Generated**: 2026-06-27T15:40:08.5859173+08:00
- **Expires**: 2026-06-27T16:40:08.5859173+08:00
- **Budget**: 312 / 2000 words

## Required Reads
- **HIGH**: `/factory-build-mode/memory-quality/policies/MEMORY_FILTERING_DECAY.md` — Filtering rules
- **HIGH**: `/factory-build-mode/memory-quality/BUILD_INTEGRATION.md` — Build integration
...
## Allowed Actions
- Integrate context packets
- Enforce freshness checks
- Reject stale packets


## Forbidden Actions
- Accept stale packets silently
- Skip ingestion policy checks
